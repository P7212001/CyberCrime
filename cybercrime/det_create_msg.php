<html>
	<head>
		...
		<title>
			Cyber Crime Cell | Detective Create Account
		</title>
        <style>
	...
	<body >
		...
		<section>
			...
			<div class="container">
				<form class="box2" method="post" action="det_create_acc_valid.php " >
					<h1>
					...
					<span class="error">Fill required fields</span><br/>
					<a href="http://localhost/Project/detective_login.php" style="color: white;">Existing Account?</a>
				</form>
			</div>
		</section>
	</body>
